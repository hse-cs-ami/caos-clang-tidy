...
llvm::ArrayRef<
    std::pair<caos::IdentifierNamingCheck::CaseType, StringRef>>
OptionEnumMapping<
    caos::IdentifierNamingCheck::CaseType>::getEnumMapping() {
  static constexpr std::pair<caos::IdentifierNamingCheck::CaseType,
                             StringRef>
      Mapping[] = {
          {caos::IdentifierNamingCheck::CT_AnyCase, "aNy_CasE"},
          {caos::IdentifierNamingCheck::CT_LowerCase, "lower_case"},
          {caos::IdentifierNamingCheck::CT_UpperCase, "UPPER_CASE"},
          {caos::IdentifierNamingCheck::CT_CamelBack, "camelBack"},
          {caos::IdentifierNamingCheck::CT_CamelCase, "CamelCase"},
          {caos::IdentifierNamingCheck::CT_CamelSnakeCase,
           "Camel_Snake_Case"},
          {caos::IdentifierNamingCheck::CT_CamelSnakeBack,
           "camel_Snake_Back"}};
...
struct OptionEnumMapping<
    caos::IdentifierNamingCheck::HungarianPrefixType> {
